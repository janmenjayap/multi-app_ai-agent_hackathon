...
3. [Per-branch execution index](branches/README.md) and
...
4. [Individual commit plans](commits/README.md), indexed by the
...
7. [Agent reliability implementation](06-agent-reliability-implementation.md):
...
8. [Agent spawning and LLM integration](07-agent-spawning-and-llm-integration.md):
